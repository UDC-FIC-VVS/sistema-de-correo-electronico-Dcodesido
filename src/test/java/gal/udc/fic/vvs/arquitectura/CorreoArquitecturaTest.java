 ...
 * @author dcode
 */
public class CorreoArquitecturaTest {
	...
	public void testClasesPublicas() {
		...
		ArchRule regla = classes().that().resideInAPackage("..correo..").should().bePublic();
	...
	public void testMetodosPublicos() {
		...
		ArchRule regla = methods().that().areDeclaredIn("..correo..").should().bePublic();
