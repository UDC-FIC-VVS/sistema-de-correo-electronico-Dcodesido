 ...
 * @author dcode
 */
public class ArchivoArquitecturaTest {
	...
	public void testClasesPublicas() {
		...
		ArchRule regla = classes().that().resideInAPackage("..archivo..").should().bePublic();
	...
	public void testMetodosPublicos() {
		...
		ArchRule regla = methods().that().areDeclaredIn("..archivo..").should().bePublic();
